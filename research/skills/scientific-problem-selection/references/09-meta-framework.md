...
- Search academic databases for precedents and adjacent work
...
2. Categorize (domain vs. technical)
...
- Find domain evidence (what's known about your context?)
...
### Overall Academic Database Approach

**Throughout the workflow, use academic databases strategically:**

1. **Skill 1 (Ideation):** Assess generality, find precedents, gauge competition
2. **Skill 2 (Risk):** Technical feasibility, domain evidence, benchmarks
