...
Researchers must actively work against these defaults by choosing the right metrics and scoring well on at least one axis.
...
A. Understand fundamental principles (fundamental knowledge)
B. Enable new research or capabilities (tool/technology)
...
**Examples:**
- **High Generality, Medium Learning:** Principles of spatial hierarchy in design
  - Updates understanding of how humans perceive space (fundamental process)
  - Scores well because spatial perception is universal

- **Medium Generality, High Learning:** Informal settlement development patterns
  - May not apply to formal planning contexts
  - BUT deep analysis reveals principles of organic urban growth
  - May yield tools for adaptive planning (bonus)

- **High on Both Axes (Landmark):** Space Syntax, pattern languages
  - These are rare—don't expect every project to be here
  - But aim to score well on at least one axis

**Key Questions:**
- How many contexts/domains does this apply to?
...
**Examples:**
- **Widely Used, Not Critical:** Rhino/Grasshopper
  - Used in countless design projects
  - Rarely THE critical tool, but enormous cumulative impact

- **Not Widely Used, Highly Critical:** Agent-based pedestrian simulation
  - Too complicated for broad adoption
  - But generates insights impossible to get otherwise
  - When you need it, nothing else works

- **High on Both Axes (Game-Changing):**
  - BIM, parametric design, GIS mapping
  - Technologies we cannot imagine designing without

**Key Questions:**
- How many researchers/practitioners would adopt this?
- For what fraction of projects is this THE enabling technology?
...
**Philosophy:** Useful for translational work, applied research, and societal impact.

**Examples:**
- Low-cost housing design: Affordable shelter for millions globally
- Accessibility improvements: Quality of life improvement for people with disabilities
- Sustainable building materials: Number of projects that can adopt the approach
...
**Scenario:** You're doing fundamental research, but reviewers ask "How widely will this be used?"

**Problem:** They're evaluating basic research with technology metrics

**Solution:** Explicitly frame as basic research. Lead with: "This updates our understanding of [fundamental process], which applies across [many contexts]."

#### Mismatch 2: Technology vs. Basic Science Evaluation
**Scenario:** You're building a tool, but reviewers ask "How much did we learn about fundamentals?"

**Problem:** They're evaluating technology with basic science metrics

**Solution:** Explicitly frame as technology development. Lead with: "This enables research that is currently impossible, which [X] groups need for [Y] applications."
...
Claude should use academic databases to benchmark impact in the user's area:
...
- Literature Support: [Key papers that inform assessment]
...
### Example 1: Space Syntax Analysis (Basic Science)
- **Framework:** Basic science
- **X-Axis (Generality):** HIGH—spatial behavior principles apply across cultures
- **Y-Axis (Learning):** MEDIUM—understanding movement patterns in specific contexts
- **Assessment:** High on generality alone = substantial impact
- **Communication:** "Updates our understanding of how spatial configuration shapes behavior"

### Example 2: Grasshopper/Parametric Design (Technology)
- **Framework:** Technology development
- **X-Axis (Widely Used):** VERY HIGH—used by architects and designers globally
- **Y-Axis (Critical):** LOW-MEDIUM—helpful but rarely essential
- **Assessment:** Extreme breadth of use = enormous cumulative impact
- **Communication:** "Enables rapid design exploration across all building types"

### Example 3: Agent-Based Pedestrian Simulation (Technology)
- **Framework:** Technology development
- **X-Axis (Widely Used):** LOW—complex, specialized, requires expertise
- **Y-Axis (Critical):** VERY HIGH—generates impossible-to-get-otherwise insights
- **Assessment:** Extreme criticality for niche = high impact
- **Communication:** "Enables prediction of pedestrian behavior in complex environments"

### Example 4: Incremental Housing Framework (Invention)
- **Framework:** Invention (custom metric)
- **X-Axis (Good):** MEDIUM—functional housing approach
- **Y-Axis (People):** VERY HIGH—millions of families in developing contexts
- **Assessment:** Massive reach × modest per-unit impact = transformative at scale
- **Communication:** "Enables affordable housing growth in resource-constrained contexts"
...
*Remember: Impact assessment isn't about ego—it's about ensuring work matters in the way the researcher wants it to matter. Explicit framing prevents years of misalignment.*
