...
- Design assumptions prove false
- You get scooped
...
1. **Technical failures:** Method doesn't work, results too noisy, etc.
2. **Domain surprises:** Context behaves unexpectedly
...
**Example: Your Dataset Can't Be Collected**
- Fix: Develop new data collection method
- Upgrade: Make method work for whole class of building types
- Result: Better project (methodology paper) + original research question
...
- Conceptual: Reason through design complexity
...
**Example 1: Space Syntax Development**
- **Original Plan:** Create tool for predicting specific movement patterns
- **Crisis:** Predictions varied significantly across contexts
- **Upgrade:** Map systematic relationships between spatial configuration and behavior
- **Result:** Better framework (discovered that configuration correlates with integration patterns)
- **Impact:** More influential than if original plan succeeded

**Example 2: Parametric Facade Study**
- **Original Plan:** Find THE optimal facade configuration
- **Crisis:** Optimal varied significantly by orientation and context
- **Upgrade:** Reframe question: How do multiple parameters interact to create performance zones?
- **Result:** Multi-criteria optimization framework (trade-off surfaces)
- **Impact:** More useful than "configuration X is optimal"
